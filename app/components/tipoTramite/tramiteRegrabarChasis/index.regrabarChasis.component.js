...
var NewTramiteRegrabarChasisComponent = (function () {
    function NewTramiteRegrabarChasisComponent(_TramiteEspecificoService, _VarianteService, _CasoService, _VehiculoService, _loginService, _route, _router) {
    ...
    NewTramiteRegrabarChasisComponent.prototype.ngOnInit = function () {
        ...
        this.tramiteEspecifico = new TramiteEspecifico_1.TramiteEspecifico(null, 8, this.tramiteGeneralId, null, null, null);
    ...
    NewTramiteRegrabarChasisComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this.vehiculo2 = new vehiculo_1.Vehiculo(this.vehiculo.id, this.vehiculo.clase.id, this.vehiculo.municipio.id, this.vehiculo.linea.id, this.vehiculo.servicio.id, this.vehiculo.color.id, this.vehiculo.combustible.id, this.vehiculo.carroceria.id, this.vehiculo.organismoTransito.id, this.vehiculo.placa, this.vehiculo.numeroFactura, this.vehiculo.fechaFactura, this.vehiculo.valor, this.vehiculo.numeroManifiesto, this.vehiculo.fechaManifiesto, this.vehiculo.cilindraje, this.vehiculo.modelo, this.vehiculo.motor, this.chasis, this.vehiculo.serie, this.vehiculo.vin, this.vehiculo.numeroPasajeros, this.vehiculo.pignorado, this.vehiculo.cancelado);
    ...
    NewTramiteRegrabarChasisComponent.prototype.onChangeCaso = function (event) {
        this.tramiteEspecifico.casoId = event;
    };
    NewTramiteRegrabarChasisComponent.prototype.onChangeVariante = function (event) {
        this.tramiteEspecifico.varianteId = event;
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], NewTramiteRegrabarChasisComponent.prototype, "tramiteGeneralId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], NewTramiteRegrabarChasisComponent.prototype, "vehiculo", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], NewTramiteRegrabarChasisComponent.prototype, "tramiteCreado", void 0);
    NewTramiteRegrabarChasisComponent = __decorate([
        core_1.Component({
    ...
    return NewTramiteRegrabarChasisComponent;
}());
exports.NewTramiteRegrabarChasisComponent = NewTramiteRegrabarChasisComponent;
//# sourceMappingURL=index.regrabarChasis.component.js.map